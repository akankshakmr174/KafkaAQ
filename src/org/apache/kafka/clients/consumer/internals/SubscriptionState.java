...
public class SubscriptionState {
    ...
    private final KafkaAQConsumer<Integer, String> aqConsumer;
    ...
    public void subscribe(Set<String> topics, ConsumerRebalanceListener listener) {
        ...
        changeAQSubscription(topics);
    }

    public void changeAQSubscription(Set<String> topics){
        aqConsumer.subscribe(topics);
