...
class KafkaTopic {
    ...
    public KafkaTopic(int partition, short replication){
        ...
        topicConfiguration.put("oracle.host", "slc12nuq.us.oracle.com:1521");
...
class Producer extends Thread {
    ...
    public Producer(String topic, Boolean isAsync) {
        ...
        props.put("bootstrap.servers", "slc12nuq.us.oracle.com:9092");
        props.put("oracle.host", "slc12nuq.us.oracle.com:1521");
...
class Consumer extends Thread{
    ...
    public Consumer(String topic) {
        ...
        Properties props = new Properties();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "slc12nuq.us.oracle.com:9092");
